...
/* ^^^ Needs to be above the media color scheme far as I can tell. */

@media (prefers-color-scheme: dark) {
    :root {
        --bs-body-bg: #1F1B24;
        --bs-table-bg: #121212a1;
...
/* Some custom code I've cooked up both above and below this line */
...
.badge-light-secondary {
    ...
    border-color: theme-color-level("secondary", -9);
    color: #6c757d;
}
...
.badge-light-light {
    ...
    border-color: theme-color-level("light", -9);
    color: #f8f9fa;
}
...
.badge-light-dark {
    ...
    border-color: theme-color-level("dark", -9);
    color: #343a40;
}
...
a.badge-light-dark.active, a.badge-light-dark:active, a.badge-light-dark:focus, a.badge-light-dark:hover {
    background: #343a40;
    border-color: #343a40;
    color: theme-color-level("dark", -10);
}
...
.bg-c-void {
    background: linear-gradient(45deg, #0E0B16, #000000);
}
...
.bg-c-stark {
    background: linear-gradient(45deg, #E7DFDD, #f1f1f1);
}
...
/* ====== [ Right here is the 3 bars for the navigation menu ] ======== */
.pcoded-header[class*="header-"] .mobile-menu span {
    background-color: rgba(0, 0, 0, 0.8);
}
...
.table-card .card-body .table tr td:nth-child(2),
  .table-card .card-body .table tr th:nth-child(2) {
    padding-left: 25px;
}

.table-card .card-body .table tr td:nth-child(3),
  .table-card .card-body .table tr th:nth-child(3) {
    padding-left: 25px;
}

.table-card .card-body .table tr td:nth-child(4),
  .table-card .card-body .table tr th:nth-child(4) {
    padding-left: 25px;
}

.table-card .card-body .table tr td:nth-child(5),
  .table-card .card-body .table tr th:nth-child(5) {
    padding-left: 25px;
}

.table-card .card-body .table tr td:nth-child(6),
  .table-card .card-body .table tr th:nth-child(6) {
    padding-left: 25px;
}
